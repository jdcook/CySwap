...
class Category extends Eloquent {
	...
	public function createCategory($post_params) {
		...
		if (array_key_exists("hasCondition", $post_params)) {
			...
			DB::insert('insert into cyswap2.category_'.$categoryName.'_config (field_name, is_searchable, is_required, character_limit, field_order) values (?, ?, ?, ?, ?)', array("item_condition", 0, $isRequired, 4, $post_params["fieldCondition_order"]));
			$categoryTableQuery = $categoryTableQuery."item_condition CHAR(4) NOT NULL,";
		}
		$i = 0;
